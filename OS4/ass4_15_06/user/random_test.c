...
int test_random(int print)
{
    ...
    if (print)
        printf("SUCCESS: Passed reading original seed\n");
    ...
    if (print)
        printf("SUCCESS: Passed looping to regenerate original seed\n");
    ...
    if (print)
        printf("SUCCESS: Passed writing a new seed\n");
    ...
    if (print)
        printf("SUCCESS: Passed looping to regenerate new seed\n");
    ...
    if (print)
        printf("SUCCESS: Passed continuity test to continue generating seed from point before closing the device\n");
    ...
    if (print)
        printf("SUCCESS: Passed generating proper values concurrently\n");
    ...
    if (print)
        printf("SUCCESS: Passed writing new seed concurrently\n");
